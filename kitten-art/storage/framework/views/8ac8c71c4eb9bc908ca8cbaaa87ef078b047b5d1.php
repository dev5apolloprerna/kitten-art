        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="quote-item">
              ...
              <form method="post" action="<?php echo e(route('trialclass_registration')); ?>" id="tialForm">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="email" placeholder="Email Address*" value="<?php echo e(old('email')); ?>" maxlength="150"  required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/frontview/trial_class.blade.php ENDPATH**/ ?>