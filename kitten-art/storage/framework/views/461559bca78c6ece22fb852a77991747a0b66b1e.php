...
<div class="main-banner">
      <div class="home-slides owl-carousel owl-theme">
        ...
        <div class="main-banner-item" style="background-image: url('<?php echo e(asset('/Banner/' . $banner->image)); ?>');">
          <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-lg-5">
            <div class="who-we-are-image">
              <img src="<?php echo e(asset('front/assets/images/who-we-are-who-we-are.png')); ?> " alt="image">
            </div>
          </div>
          <div class="col-lg-7">
            <div class="who-we-are-content">
              <span>Who We Are</span>
              <h3>Develop Essential Art Skills With a Strong Foundation</h3>
              <p><?php echo $about->description; ?></p>
              <ul class="who-we-are-list">
                <li>
                  <span>1</span> Drawing Fundamentals
                  <p>Observation skills, proportion, shading, and perspective</p>
                </li>
                <li>
                  <span>2</span> Painting Techniques
                  <p>Color theory, blending, brushwork, and composition</p>
                </li>
                <li>
                  <span>3</span> Art Elements & Principles
                  <p>Line, shape, texture, balance, and contrast</p>
                </li>
                <li>
                  <span>4</span> Medium Exploration
                  <p>Graphite, oil Pastels, watercolor, acrylics, color pencils and mixed media.</p>
                </li>
                <li>
                  <span>5</span> Progressive Curriculum
                  <p> Lessons build sequentially to reinforce knowledge and skill mastery </p>
                </li>
              </ul> 
              <div class="who-we-are-btn">
                <a href="<?php echo e(route('FrontAbout')); ?>" class="default-btn">Read More</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-class">
              <div class="class-image">
                <a href="#">
                  <?php if($data->plan_image == '' || !file_exists(public_path('plan_image/' . $data->plan_image))): ?>
                      <img src="<?php echo e(asset('images/noImage.png')); ?>" height="2px" >
                  <?php else: ?>
              ...
              <div class="class-content">
                ...
                <h3>
                  <a href="<?php echo e(route('FrontClassDetail',$data->planId)); ?>">  <?php echo e($data->categoryName); ?> </a>
                </h3>
                <p><?php echo e($data->plan_name); ?></p>
                <p><?php echo $data->plan_description; ?></p>
                ...
                <div class="class-btn">
                  <a href="<?php echo e(route('FrontClassDetail',$data->planId)); ?>" class="default-btn">Join Class</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="value-image">
              <img src="<?php echo e(asset('front/assets/images/img-core.jpg')); ?>" alt="image">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="value-item">
              ...
              <div class="value-inner-content">
                ...
                <h4>Small class sizes (8-10 students)</h4>
              ...
              <div class="value-inner-content">
                ...
                <h4>Experienced, passionate instructor</h4>
                <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p> -->
              </div>
              <div class="value-inner-content">
                <div class="number">
      ...
      <div class="container-fluid">
        ...
        <div class="gallery-slides owl-carousel owl-theme">
          ...
          <div class="single-teacher">
            <div class="image">
              <img src="<?php echo e(asset('Gallery/') . '/' . $g->image); ?>" alt="image">
            </div>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="quote-image">
              <img src="<?php echo e(asset('front/assets/images/img-quote.png')); ?>" />
            </div>
          </div>
                <?php echo $__env->make('common.alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          ...
          <div class="col-lg-6">
            <div class="quote-item">
              ...
              <form method="post" action="<?php echo e(route('student_registration')); ?>" id="myForm">
                <?php echo csrf_field(); ?>
                
               <div class="form-group">
                  <input type="text" class="form-control" name="student_first_name" id="student_first_name" placeholder="Student First Name*" minlength="3"  maxlength="20" value="<?php echo e(old('student_first_name')); ?>" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '')"  required>
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="student_last_name" id="student_last_name" placeholder="Student Last Name*" minlength="3"  maxlength="20" value="<?php echo e(old('student_last_name')); ?>" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '')"  required>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="parent_name" id="parent_name" placeholder="Parents Name*" maxlength="100" value="<?php echo e(old('parent_name')); ?>" minlength="3"  oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '')"  required>
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                  <input type="checkbox" name="termCondition" id="termCondition" value="1"> <b> I Agree <a href="<?php echo e(route('termandcondition')); ?>" target="_blank" style="color:red";> Terms and Condition</a></b>
                </div>
          ...
          <div class="testimonials-item">
            <div class="testimonials-item-box justify-content-between">
              <div class="icon col-lg-4">
                <img src="<?php echo e(asset($data['student_photo'] ? 'Testimonial/' . $data['student_photo'] : 'images/image1.png')); ?>" class="img-fluid">
              </div>
              <div class="col-lg-7 align-content-center">
                <p><?php echo $data['description']; ?></p>
                <div class="info-box d-flex">
                  <div class="testi-img">
                    <img src="<?php echo e(asset($data['parent_photo'] ? 'Testimonial/' . $data['parent_photo'] : 'images/image2.png')); ?>">
                  </div>
                   <h3 class="align-content-center"><?php echo e($data['parent_name']); ?></h3>
                  <span> Parent of <?php echo e($data['student_name']); ?></span>
                </div>
              </div>
            </div>
    ...
    $(document).ready(function () {
        $('#termCondition').change(function () {
            if ($(this).is(':checked')) {
                ...
                // window.open('<?php echo route('termandcondition'); ?>', '_blank');
    ...
    <div class="modal-dialog">
      <div class="modal-content">
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            <a href="<?php echo e(route('FrontRegistration')); ?>">
                <img src="<?php echo e(asset($image->image ? 'POPUPImage/' . $image->image : 'images/noImage.png')); ?>" class="img-fluid" />
           </a>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/frontview/index.blade.php ENDPATH**/ ?>