...
<head>
    ...
    <meta charset="utf-8" />
    <title><?php echo e(env('APP_NAME')); ?> | Log Out </title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Themesbrand" name="author" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?php echo e(asset('front/images/facicon.png')); ?>">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <img src="<?php echo e(asset('front/images/logo.png')); ?>" alt="" height="190">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/logout.blade.php ENDPATH**/ ?>