                                            ...
                                            <form method="POST" action="{{ route('gallery.store') }}" autocomplete="off"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-4 mb-3">
                                                        ...
                                                        <textarea id="editor1" name="comment" class="form-control" >{{ old('comment') }}</textarea>  
                                                    </div>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                            ...
                                            <tbody>
                                             @if(count($gallery) > 0)
                                                <?php $i = 1; ?>
                                                    @foreach($gallery as $key => $glry)
                                                    <tr class="text-center">
                                                        <td>{{ $i + $gallery->perPage() * ($gallery->currentPage() - 1) }}
                                                        </td>
                                                        <td>
                                                            <!-- Image Thumbnail with Click Event -->
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#imageModal_{{ $i }} ">
                                                        <img width="50" height="50" src="{{ asset($glry->image ? 'Gallery/' . $glry->image : 'images/noImage.png') }}">
                                                    </a>
                                                    ...
                                                    <div class="modal fade" id="imageModal_{{ $i }}" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center">
                                                                    <img id="modalImage" src="{{ asset($glry->image ? 'Gallery/' . $glry->image : 'images/noImage.png') }}" class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <td>@if($glry->type == 1) {{ 'Owner' }} 
                                                            @elseif($glry->type == 2) {{ 'Student' }} 
                                                            @else
                                                                {{ '-' }}
                                                            @endif
                                                        </td>
                                                        <td>{{ Str::words($glry->comment ?? '-', 3, '...') }}</td>
                                                        ...
                                                        <td>
                                                            <div class="gap-2">
                                                                ...
                                                                <a class="" href="#" data-bs-toggle="modal"
                                                                 ...
                                                                 <a class="mx-1"  href="#" data-bs-toggle="modal" data-bs-target="#viewModal_{{$glry->gallery_id}}" title="View">
                                                    ...
                                                    <!------model for view description ------------------->
                                                        ...
                                                        <div class="modal fade flip" id="viewModal_{{$glry->gallery_id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <script>
         ...
         function getGalleryEditData(id) 
         {
            ...
            if (id) {
                ...
                var updateUrl = "{{ route('gallery.update', ':id') }}";
