            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                             <form method="POST" action="{{ route('testimonial.update',$data['testimonial_id']) }}" autocomplete="off" enctype="multipart/form-data" id="testimonial_edit">
                                @csrf
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('parent_photo') ? 'has-error' : '' }}">
                                               ...
                                               <input type="hidden" name="hiddenImage2" class="form-control"
                                                        ...
                                                        id="hiddenImage2">
                                                    <div id="viewimg">
                                                        <img src="{{ asset($data['parent_photo'] ? 'Testimonial/' . $data['parent_photo'] : 'images/image1.png') }}"
                                       ...
                                       <div class="col-md-6 mt-4">
                                        <div class="form-group {{ $errors->has('student_photo') ? 'has-error' : '' }}">
                                            ...
                                            <input type="hidden" name="hiddenImage1" class="form-control"
                                                        ...
                                                        id="hiddenImage1">
                                                    <div id="viewimg">
                                                        <img src="{{ asset($data['student_photo'] ? 'Testimonial/' . $data['student_photo'] : 'images/image2.png') }}"
                                                            alt="" height="70" width="70">  
