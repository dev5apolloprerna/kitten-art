                                                            ...
                                                            <tr data-entry-id="{{ $sdata->testimonial_id }}" class="text-center">
                                                                ...
                                                                <td>
                                                                    <a target="_blank" href="{{ asset($sdata->parent_photo ? 'Testimonial/' . $sdata->parent_photo : 'images/noImage.png') }}">
                                                                        <img width="50" height="50" src="{{ asset($sdata->parent_photo ? 'Testimonial/' . $sdata->parent_photo : 'images/image1.png') }}">
                                                                    </a>
                                                                </td>
                                                                ...
                                                                <td>
                                                                     <a target="_blank" href="{{ asset($sdata->student_photo ? 'Testimonial/' . $sdata->student_photo : 'images/noImage.png') }}">
                                                                        <img width="50" height="50" src="{{ asset($sdata->student_photo ? 'Testimonial/' . $sdata->student_photo : 'images/image2.png') }}">
                                                                    </a>
