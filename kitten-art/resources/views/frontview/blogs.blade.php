                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-item">
                            ...
                            <div class="blog-content">
                                ...
                                <h3>
                                    <a href="{{route('FrontBlogdetail')}}">Red Green Color Blindness</a>
                                </h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>

                                <div class="blog-btn">
                                    <a href="{{route('FrontBlogdetail')}}" class="default-btn">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-item">
                            ...
                            <div class="blog-content">
                                ...
                                <h3>
                                    <a href="{{route('FrontBlogdetail')}}">8 Ways to Learning Lesson</a>
                                </h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-item">
                            ...
                            <div class="blog-content">
                                ...
                                <h3>
                                    <a href="{{route('FrontBlogdetail')}}">Full-Day Session With Activities</a>
                                </h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
