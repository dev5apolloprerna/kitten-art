        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                @foreach($active_plan as $plan1)
                    @if($debit_balance != $plan1->total_session)
                            ...
                            <div class="event-content">
                                ...
                                <ul class="event-list">
                                    ...
                                    <li>
                                        ...
                                        {{ date('h:i a',strtotime($plan1->batch_from_time)) }} - {{ date('h:i a',strtotime($plan1->batch_to_time)) }}
                                    </li>

                                    <li>
                                        <i class="bx bx-dollar"></i>
                                        {{ $plan1->amount }} - {{ $plan1->total_session }} session
                                    </li>
                                </ul>
                            </div>
                        </div>
