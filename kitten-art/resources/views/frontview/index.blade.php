...
<div class="main-banner">
      <div class="home-slides owl-carousel owl-theme">
        ...
        <div class="main-banner-item" style="background-image: url('{{ asset('/Banner/' . $banner->image) }}');">
          <div class="container">
          ...
          <div class="testimonials-item">
            <div class="testimonials-item-box justify-content-between">
              <div class="icon col-lg-4">
                <img src="{{ asset($data['student_photo'] ? 'Testimonial/' . $data['student_photo'] : 'images/image1.png') }}" class="img-fluid">
              </div>
              <div class="col-lg-7 align-content-center">
                <p>{!! $data['description'] !!}</p>
                <div class="info-box d-flex">
                  <div class="testi-img">
                    <img src="{{ asset($data['parent_photo'] ? 'Testimonial/' . $data['parent_photo'] : 'images/image2.png') }}">
                  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            <a href="{{route('FrontRegistration')}}">
                <img src="{{ asset($image->image ? 'POPUPImage/' . $image->image : 'images/noImage.png') }}" class="img-fluid" />
           </a>
      </div>
    </div>
  </div>
