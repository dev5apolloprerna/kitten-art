    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link @if (request()->routeIs('plan.index', 'plan.create', 'plan.edit')) active @endif"
               ...
               @php $ctx = request('ctx'); @endphp

                 <li class="nav-item">
                        <a class="nav-link menu-link {{ request()->routeIs([
                          'studentinquiry.index','studentinquiry.view','studentinquiry.edit',
                          'student.index','student.register_student','student.active_student',
                          'student.view','student.edit','student.active_student_view',
                          'renewPlan.renew_plan','renewPlan.edit_renew_student','student.inactive_student'
                      ]) ? 'active' : 'collapsed' }}"
                        ...
                        " id="sidebarDashboards" style="">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    ...
                                    @if (request()->routeIs('studentinquiry.index', 'studentinquiry.view', 'studentinquiry.edit')) active @endif"
                                        data-key="t-crm">
                                ...
                                <li class="nav-item">
                                    ...
                                    @if (request()->routeIs('student.register_student', 'student.view', 'student.edit')) active @endif"
                                        data-key="t-crm">
                                ...
                                <li class="nav-item">
                                 ...
                                 @if (request()->routeIs('renewPlan.renew_plan', 'renewPlan.edit_renew_student')) active @endif"
                                        data-key="t-crm">
                                        <i class="fas fa-credit-card"></i>Renew Student Plan</a>
                                </li>
                                <li class="nav-item">
                                   <a href="{{ route('student.inactive_student') }}"
                                      class="nav-link menu-link
                                      {{ request()->routeIs('student.inactive_student') ? 'active' : '' }}
                                      {{ request()->routeIs('student.active_student_view') && $ctx === 'inactive' ? 'active' : '' }}">
                                      <i class="fas fa-credit-card"></i> Inactive Student
                                   </a>
                                </li>
                ...
                <li class="nav-item">
                        ...
                        " id="reportsidebar" style="">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('report.attendance_report') }}" class="nav-link menu-link @if (request()->routeIs('report.attendance_report')) {{ 'active' }} @endif"
                                        data-key="t-crm">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link @if (request()->routeIs('popupImage.image')) {{ 'active' }} @endif"
                        href="{{ route('popupImage.image') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link @if (request()->routeIs('events.index', 'events.create', 'events.edit')) active @endif"
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link @if (request()->routeIs('testimonial.index', 'testimonial.create', 'testimonial.edit')) active @endif"
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link @if (request()->routeIs('trialClass.index', 'trialClass.view')) active @endif"
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link @if (request()->routeIs('service.index', 'service.create','service.edit','service.images')) active @endif"
                  ...
                  <li class="nav-item">
                    <a class="nav-link menu-link @if (request()->routeIs('page.index', 'page.edit')) active @endif
                        "
