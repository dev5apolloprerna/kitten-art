...
@section('title', 'Edit Active Student')
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('student.update', $data['student_id']) }}" method="POST" enctype="multipart/form-data" id="student_edit">
                                    @csrf
                                    <input type="hidden" name="student_id" id="student_id" value="{{ $data['student_id'] }}">
                                    <input type="hidden" name="isPaid" id="isPaid" value="{{ $data['isPaid'] }}">
                                    <input type="hidden" name="isRegister" id="isRegister" value="{{ $data['isRegister'] }}">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-4 mt-4">
                                            <div class="form-group {{ $errors->has('student_first_name') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" id="student_first_name" name="student_first_name" class="form-control"  placeholder="Enter Student Name" maxlength="100" value="{{ $data['student_first_name'] }}">
                                        ...
                                        <div class="col-md-4 mt-4">
                                            <div class="form-group {{ $errors->has('student_last_name') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" id="student_last_name" name="student_last_name" class="form-control"  placeholder="Enter Student Name" maxlength="100" value="{{ $data['student_last_name'] }}">
                                        ...
                                        <div class="col-md-4 mt-4">
                                            <div class="form-group {{ $errors->has('student_age') ? 'has-error' : '' }}">
                                                ...
                                                <input type="number" id="student_age" name="student_age" class="form-control" placeholder="Enter Student Age" maxlength="2" value="{{ $data['student_age'] }}" disabled>
                                        ...
                                        <div class="card-footer mt-2">
                                            <div class="mb-3" style="float: right;">
                                                ...
                                                <a class="btn btn-primary float-right mr-3"
                                                    href="{{ route('student.active_student') }}">Cancel</a>
                                            </div>
                                        </div>
                                </form>
                            </div>
