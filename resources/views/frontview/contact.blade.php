            ...
            <form method="post" action="{{ route('contactStore') }}" id="contactForm" novalidate>
              ...
              <div class="row">
                ...
                <div class="col-sm-6 mb-3 form-group-icon">
                  ...
                  <input type="text" class="form-control" name="student_first_name" id="student_first_name" placeholder="First Name" maxlength="20" value="{{ old('student_first_name') }}" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '')"  required>
                <div class="error" id="error1" style="color:red"></div>
                </div>

                 <div class="col-sm-6 mb-3 form-group-icon">
                  <i class="bi bi-person"></i>
                  <input type="text" class="form-control" name="student_last_name" id="student_last_name" placeholder="Last Name" maxlength="20" value="{{ old('student_last_name') }}" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '')"  required>
                <div class="error" id="error1" style="color:red"></div>
                </div>
