        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <div class="">
                        <form method="post" id="form" action="{{ route('tickettype.adminshowpendingticket') }}">
                            @csrf
                                ...
                                <div class="col-md-3 mt-2 mb-2">
                                    <div class="d-flex align-items-center">
                                        <input placeholder="Mobile" type="text" class="form-control"
                                            ...
                                            autocomplete="off" name="imobile" value="<?= isset($Mobile) ? $Mobile : '' ?>">
                                    </div>
                                </div>
                                <div class="col-md-3 mt-2 mb-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <a class="" title="Edit"
                                                            href="{{ route('tickettype.admineditticket', $ticket->ticketId) }}">
