                                        ...
                                        <div class="row gy-4" style="align-items: end;">
                                            ...
                                            <div class="col-lg-3 col-md-3">
                                                <div>
                                                    ...
                                                    <select class="form-control" name="ifinalticketstatus" required>
                                                        <option selected disabled value="">Select Current Status
                                                        </option>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($Ticket as $ticket)
                                            <tr>
                                                ...
                                                <td>{{ $ticket->ifinalticketstatus }}</td>
                                                <td>{{ $ticket->ienterbyname }}</td>
                                                <td>{{ $ticket->ifinalticketclosedByname }}</td>
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        @if ($ticket->iticketassignstatus == 0)
                                                            <a title="Accept"
                                                                href="{{ route('ticket.ticketassignonbutton', $ticket->ticketId) }}">
