...
<section class="class-area bg-fdf6ed pt-100 pb-70">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="">
              <img src="<?php echo e(asset('front/assets/images/register.jpg')); ?>" />
            </div>
          </div>
          <div class="col-lg-6">
            <div class="quote-item">
              ...
              <!--<form method="post" action="<?php echo e(route('student_registration')); ?>">-->
                <?php echo csrf_field(); ?>
                <input type="hidden" id="batchId" value="<?php echo e($batchId); ?>">
                <input type="hidden" id="planId" value="<?php echo e($planId); ?>">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <!-- <input type="number" class="form-control" name="student_age" id="student_age" placeholder="Kids Age*" max="99" min="0" oninput="if(this.value.length > 2) this.value = this.value.slice(0, 2);" value="<?php echo e(old('student_age')); ?>" required> -->
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="tel" class="form-control" name="mobile" placeholder="Your Phone*" minlength="5" maxlength="10" value="<?php echo e(old('mobile')); ?>" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" required>
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="email" placeholder="Email Address*" maxlength="150" value="<?php echo e(old('email')); ?>" required>
                </div>
                <div class="form-group">
                 <select class="form-control" aria-label="Default select Class" name="category_id" id="category_id" required>
                    ...
                    <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($c->category_id); ?>" <?php echo e($c->category_id == $categoryId || old('category_id') == $c->category_id ? 'selected' : ''); ?>><?php echo e($c->category_name); ?></option>
                ...
                <div class="form-group">
                    <select class="form-control" aria-label="Default select Class" name="communication_mode" id="communication_mode" required>
                            ...
                            <option value="1" <?php echo e(old('communication_mode')==1 ? 'selected' :''); ?>>Whats App</option>
                            <option value="2" <?php echo e(old('communication_mode')==2 ? 'selected' :''); ?>>Email</option>
                            <option value="3" <?php echo e(old('communication_mode')==3 ? 'selected' :''); ?>>Text SMS</option>
                    </select>
                </div>
                <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/frontview/registration.blade.php ENDPATH**/ ?>