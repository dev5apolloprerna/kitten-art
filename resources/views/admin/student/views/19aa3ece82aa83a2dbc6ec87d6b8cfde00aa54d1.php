            ...
            <ul class="navbar-nav" id="navbar-nav">
               ...
               <?php $ctx = request('ctx'); ?>
                 ...
                 <li class="nav-item">
                        ...
                        <div class="menu-dropdown collapse <?php echo e(request()->routeIs([
                              'studentinquiry.index','student.index','student.register_student','student.active_student',
                        ...
                        " id="sidebarDashboards" style="">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('student.active_student')); ?>"
                                       class="nav-link menu-link
                                       <?php echo e(request()->routeIs('student.active_student','student.active_student_view','student.activeEdit') && $ctx !== 'inactive' ? 'active' : ''); ?>">
                                ...
                                <li class="nav-item">
                                   <a href="<?php echo e(route('student.inactive_student')); ?>"
                                      class="nav-link menu-link
                                      <?php echo e(request()->routeIs('student.inactive_student') ? 'active' : ''); ?>

                                      <?php echo e(request()->routeIs('student.active_student_view') && $ctx === 'inactive' ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                        ...
                        <div class="menu-dropdown collapse <?php echo e(in_array(request()->route()->getName(), ['report.upcoming_renew','report.renewal_report','report.attendance_report','report.upcoming_view']) ? 'show' : ''); ?>

                        " id="reportsidebar" style="">
                            <ul class="nav nav-sm flex-column">
                               
                                <li class="nav-item">
                                    <a href="<?php echo e(route('report.renewal_report')); ?>" class="nav-link menu-link
                                    <?php if(request()->routeIs('report.renewal_report', 'report.upcoming_view')): ?> active <?php endif; ?>"
                                        data-key="t-crm">
