<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?php echo e(asset('/front/images/logo.png')); ?>">
...
<?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/auth/includes/head.blade.php ENDPATH**/ ?>