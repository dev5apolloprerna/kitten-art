<?php $__env->startSection('title', 'Popup Image'); ?>
                                            ...
                                            <tbody>
                                                <?php $i = 1; ?>
                                                    ...
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#imageModal_<?php echo e($i); ?> ">
                                                        <img width="50" height="50" src="<?php echo e(asset($gallery->image ? 'POPUPImage/' . $gallery->image : 'images/noImage.png')); ?>">
                                                    </a>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center">
                                                                    <img id="modalImage" src="<?php echo e(asset($gallery->image ? 'POPUPImage/' . $gallery->image : 'images/noImage.png')); ?>" class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <td>
                                                            <div class="gap-2">
                                                                <a class="mx-1" title="Edit" href="#"
                                                                 ...
                                                                 <a class="mx-1"  href="#" data-bs-toggle="modal" data-bs-target="#viewModal_<?php echo e($gallery->image_id); ?>" title="View">
                ...
                <div class="modal fade flip" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="<?php echo e(route('popupImage.updateImage')); ?>" autocomplete="off"
...
<?php $__env->startSection('scripts'); ?>
        <script>
         ...
         {
            var url = "<?php echo e(route('popupImage.editImage', ':id')); ?>";
            ...
            if (id) {
                ...
                var updateUrl = "<?php echo e(route('popupImage.updateImage', ':id')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/admin/popupImage/index.blade.php ENDPATH**/ ?>