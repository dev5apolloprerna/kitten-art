                                            ...
                                            <div class="table-responsive">
                                                <table class=" table table-bordered table-striped table-hover datatable">
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="modal fade flip" id="paymentModal_<?php echo e($sdata->student_id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <input type="hidden" name="student_request_id" id="paymentid" value="<?php echo e($sdata->student_id); ?>">
