            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                             <form method="POST" action="<?php echo e(route('testimonial.update',$data['testimonial_id'])); ?>" autocomplete="off" enctype="multipart/form-data" id="testimonial_edit">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="testimonial_id" value="<?php echo e($data['testimonial_id']); ?>">
                                    <div class="row">
                                        <div class="col-md-6 mt-4">
                                            <div class="form-group <?php echo e($errors->has('parent_name') ? 'has-error' : ''); ?>">
                                                ...
                                                <input type="text" id="parent_name" name="parent_name" class="form-control" value="<?php echo e($data['parent_name']); ?>" maxlength="100" required>
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <div class="form-group <?php echo e($errors->has('parent_photo') ? 'has-error' : ''); ?>">
                                               ...
                                               <input type="hidden" name="hiddenImage2" class="form-control"
                                                        value="<?php echo e(old('parent_photo') ? old('parent_photo') : $data['parent_photo']); ?>"
                                                        id="hiddenImage2">
                                                    <div id="viewimg">
                                                        <img src="<?php echo e(asset($data['parent_photo'] ? 'Testimonial/' . $data['parent_photo'] : 'images/image1.png')); ?>"
                                                            alt="" height="70" width="70">
                                                        <?php $__errorArgs = ['parent_photo'];
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <div class="form-group <?php echo e($errors->has('student_name') ? 'has-error' : ''); ?>">
                                                ...
                                                <input type="text" id="student_name" name="student_name" class="form-control" value="<?php echo e($data['student_name']); ?>" maxlength="100">
                                       ...
                                       <div class="col-md-6 mt-4">
                                        <div class="form-group <?php echo e($errors->has('student_photo') ? 'has-error' : ''); ?>">
                                            ...
                                            <input type="hidden" name="hiddenImage1" class="form-control"
                                                        value="<?php echo e(old('student_photo') ? old('student_photo') : $data['student_photo']); ?>"
                                                        id="hiddenImage1">
                                                    <div id="viewimg">
                                                        <img src="<?php echo e(asset($data['student_photo'] ? 'Testimonial/' . $data['student_photo'] : 'images/image2.png')); ?>"
                                                            alt="" height="70" width="70">  
                                ...
                                <div class="card-footer mt-2">
                                            <div class="mb-3" style="float: right;">
                                                ...
                                                <a class="btn btn-primary float-right mr-3"
                                                    href="<?php echo e(route('testimonial.index')); ?>">Cancel</a>
                                            </div>
                                        </div>
                            </form>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/admin/testimonial/edit.blade.php ENDPATH**/ ?>