    ...
    <div class="container">
        ...
        <div class="row clearfix">
          ...
          <div class="contact-panel">
            ...
            <form method="post" action="<?php echo e(route('contactStore')); ?>" id="contactForm" novalidate>
                <?php echo csrf_field(); ?>
              <div class="row">
                ...
                <i class="bi bi-book"></i>
                  <select class="form-select" name="category_id" id="category_id">
                    ...
                    <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($c->category_id); ?>"  <?php echo e(old('category_id') == $c->category_id ? 'selected' : ''); ?>><?php echo e($c->category_name); ?></option>
                ...
                <div class="col-sm-6 mb-3 form-group-icon">
                  ...
                  <input type="text" class="form-control" name="student_first_name" id="student_first_name" placeholder="First Name" maxlength="20" value="<?php echo e(old('student_first_name')); ?>" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '')"  required>
                <div class="error" id="error1" style="color:red"></div>
                </div>

                 <div class="col-sm-6 mb-3 form-group-icon">
                  <i class="bi bi-person"></i>
                  <input type="text" class="form-control" name="student_last_name" id="student_last_name" placeholder="Last Name" maxlength="20" value="<?php echo e(old('student_last_name')); ?>" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '')"  required>
                <div class="error" id="error1" style="color:red"></div>
                </div>
                ...
                <div class="col-sm-6 mb-3 form-group-icon">
                  ...
                  <select class="form-control" name="student_age" id="student_age" required>
                    ...
                    <!-- <input type="text" class="form-control" name="student_age" id="student_age" placeholder="Student Age" value="<?php echo e(old('student_age')); ?>" max="99" min="0" oninput="if(this.value.length > 2) this.value = this.value.slice(0, 2);" required>
                     -->           
                 </div>
                <!-- <div class="col-sm-6 mb-3 form-group-icon">
                  <i class="bi bi-person"></i>
                  <input type="text" class="form-control" name="parent_name" id="parent_name" placeholder="Parents Name" value="<?php echo e(old('parent_name')); ?>" maxlength="20" oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '')" required>
                ...
                <div class="col-sm-6 mb-3 form-group-icon">
                  ...
                  <input type="email" class="form-control" name="email" placeholder="Email" value="<?php echo e(old('email')); ?>" maxlength="150"  required>
                </div>

                <div class="col-sm-6 mb-3 form-group-icon">
                  <i class="bi bi-telephone"></i>
                  <input type="text" class="form-control" name="mobile" placeholder="Phone" value="<?php echo e(old('mobile')); ?>"  minlength="5" maxlength="10"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"required>
                </div>
                <div class="col-sm-6 mb-3 form-group-icon">
                    <i class="bi bi-chat-text"></i>
                  <textarea  class="form-control" name="message" placeholder="Message" required><?php echo e(old('message')); ?></textarea>
                </div>
                ...
                <div class="inner-column">
                    <ul class="contact-info">
                        ...
                        <i class="fa fa-home " ></i>
                            ...
                            <p> 
                           1021 Forestville road, suite 200, 2nd floor, Wake Forest, 27587.</p>
                        </li>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3230.2037049120445!2d-78.50921812439593!3d35.941986472504205!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89ac51bb7777433d%3A0x7b3ba590d4044b4d!2s1021%20Forestville%20Rd%2C%20Wake%20Forest%2C%20NC%2027587%2C%20USA!5e0!3m2!1sen!2sin!4v1753086445250!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/frontview/contact.blade.php ENDPATH**/ ?>