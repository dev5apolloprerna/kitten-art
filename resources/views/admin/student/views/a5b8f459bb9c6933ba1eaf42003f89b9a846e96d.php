<?php $__env->startSection('title', 'Student WaitList'); ?>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Student WaitList
                                    <a href="<?php echo e(route('student.create')); ?>" style="float: right;" class="btn btn-sm btn-primary">
                            ...
                            <div class="card-body">
                                <form method="post" action="<?php echo e(route('student.index')); ?>" id="myForm">
                                    <?php echo csrf_field(); ?>
                                     <div class="row"> 
                                        <div class="col-md-5"> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/admin/student/index.blade.php ENDPATH**/ ?>