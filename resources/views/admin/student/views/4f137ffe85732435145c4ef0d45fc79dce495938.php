            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="<?php echo e(route('home')); ?>" class="logo logo-dark">
                        <span class="logo-lg">
                            <img src="<?php echo e(asset('front/assets/images/logo.png')); ?>" alt="" height="80">
                        </span>
                    </a>
                </div>
...
<?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/common/header.blade.php ENDPATH**/ ?>