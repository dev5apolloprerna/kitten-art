        ...
        <div class="row">
          <div class="col-lg-3 col-sm-6">
            <div class="single-footer-widget">
              <div class="logo">
                <h2>
                  <a href="<?php echo e(route('FrontIndex')); ?>">Kitten Art Classes</a>
                </h2>
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="single-footer-widget pl-5">
              ...
              <ul class="quick-links">
                ...
                <li>
                  <a href="<?php echo e(route('FrontAbout')); ?>">About us</a>
                </li>
                <li>
                  <a href="<?php echo e(route('FrontClass')); ?>">Classes</a>
                </li>
                <!-- <li>
                  <a href="<?php echo e(route('FrontService')); ?>">Services</a>
                </li> -->
                <li>
                  <a href="<?php echo e(route('FrontContact')); ?>">Contact us</a>
                </li>
                <li>
                  <a href="<?php echo e(route('termandcondition')); ?>">Terms And Conditions</a>
                </li>
                <li>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="single-footer-widget">
              ...
              <ul class="footer-contact-info">
                ...
                <li>
                  <i class="bx bx-map"></i>
                  <span>Address</span> 1021 Forestville road, suite 200, 2nd floor, Wake Forest, 27587.
                </li>
              </ul>
            </div>
          </div>
    ...
    </div><?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/common/frontfooter.blade.php ENDPATH**/ ?>