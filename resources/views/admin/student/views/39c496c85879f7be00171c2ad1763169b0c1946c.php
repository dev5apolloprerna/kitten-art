<?php $__env->startSection('title', 'Edit Active Student'); ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Edit Active Student</h4>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?php echo e(route('student.update', $data['student_id'])); ?>" method="POST" enctype="multipart/form-data" id="student_edit">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="student_id" id="student_id" value="<?php echo e($data['student_id']); ?>">
                                    <input type="hidden" name="isPaid" id="isPaid" value="<?php echo e($data['isPaid']); ?>">
                                    <input type="hidden" name="isRegister" id="isRegister" value="<?php echo e($data['isRegister']); ?>">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-4 mt-4">
                                            <div class="form-group <?php echo e($errors->has('student_age') ? 'has-error' : ''); ?>">
                                                ...
                                                <input type="number" id="student_age" name="student_age" class="form-control" placeholder="Enter Student Age" maxlength="2" value="<?php echo e($data['student_age']); ?>" disabled>
                                        ...
                                        <div class="card-footer mt-2">
                                            <div class="mb-3" style="float: right;">
                                                ...
                                                <a class="btn btn-primary float-right mr-3"
                                                    href="<?php echo e(route('student.active_student')); ?>">Cancel</a>
                                            </div>
                                        </div>
                                </form>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/admin/student/active_student_edit.blade.php ENDPATH**/ ?>