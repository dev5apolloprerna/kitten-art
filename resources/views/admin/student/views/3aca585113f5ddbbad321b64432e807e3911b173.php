                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="live-preview">
                                            <form method="POST" action="<?php echo e(route('banner.store')); ?>" autocomplete="off"
                                        ...
                                        <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                            ...
                                            <tbody>
                                             <?php if(count($banner) > 0): ?>
                                                <?php $i = 1; ?>
                                                    <?php $__currentLoopData = $banner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $glry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="text-center">
                                                        <td><?php echo e($i + $banner->perPage() * ($banner->currentPage() - 1)); ?>

                                                        </td>
                                                        <td>
                                                            <!-- Image Thumbnail with Click Event -->
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#imageModal_<?php echo e($i); ?> ">
                                                        <img width="50" height="50" src="<?php echo e(asset($glry->image ? 'Banner/' . $glry->image : 'images/noImage.png')); ?>">
                                                    </a>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center">
                                                                    <img id="modalImage" src="<?php echo e(asset($glry->image ? 'Banner/' . $glry->image : 'images/noImage.png')); ?>" class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <td>
                                                            <div class="gap-2">
                                                                ...
                                                                <a class="" href="#" data-bs-toggle="modal"
                                                                 ...
                                                                 <a class="mx-1"  href="#" data-bs-toggle="modal" data-bs-target="#viewModal_<?php echo e($glry->bannerId); ?>" title="View">
                ...
                <div class="modal fade flip" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="<?php echo e(route('banner.update')); ?>" autocomplete="off"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                    ...
                                    <form id="user-delete-form" method="POST" action="<?php echo e(route('banner.destroy')); ?>">
                                        <?php echo csrf_field(); ?>
        ...
        <script>
         ...
         function getGalleryEditData(id) 
         {
            ...
            if (id) {
                ...
                var updateUrl = "<?php echo e(route('banner.update', ':id')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/admin/banner/index.blade.php ENDPATH**/ ?>