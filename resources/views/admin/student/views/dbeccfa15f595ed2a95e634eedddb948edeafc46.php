                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <h5 class="card-title mb-0">Student Details
                                    ...
                                    <a href="<?php echo e(route('attendance.index')); ?>" style="float: right;" class="btn btn-sm btn-primary">
...
<?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="card mb-4 shadow-sm border-0">
        ...
        <div class="card-body">
            <div class="row mb-2">
                <div class="col-md-4"><strong>Payment Date:</strong> <?php echo e($sub->payment_date ? date('d-m-Y', strtotime($sub->payment_date)) : '-'); ?></div>
                <div class="col-md-4"><strong>Payment Mode:</strong> <?php echo e($sub->payment_mode); ?></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/admin/student_attendance/student_view.blade.php ENDPATH**/ ?>