<?php $__env->startSection('title', 'Upcoming Renewal Student List'); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post" action="<?php echo e(route('report.upcoming_renew')); ?>" id="myForm">
                                    <?php echo csrf_field(); ?>
                                     <div class="row"> 
                                        <div class="col-md-4"> 
                                                            ...
                                                            <tr data-entry-id="<?php echo e($sdata->student_id); ?>" class="text-center">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex gap-2">
                                                                        ...
                                                                        <a class="" title="View"
                                                                            href="<?php echo e(route('report.upcoming_view', $sdata->student_id)); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/labtrade/public_html/kittenart/newkittenart/resources/views/admin/report/index.blade.php ENDPATH**/ ?>