                                                ...
                                                <table class=" table table-bordered table-striped table-hover datatable">
                                                    ...
                                                    ?>
                                                        @foreach($Student as $key => $sdata)
                                                            <tr data-entry-id="{{ $sdata->student_id }}"  data-subscription-id="{{ $sdata->subscription_id }}" class="text-center">
                                                                <td >
                                                                    <input type="checkbox" class="student-checkbox" value="{{ $sdata->student_id }}" data-subscription-id="{{ $sdata->subscription_id }}">
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex gap-3">
                                                                        ...
                                                                        data-student-id="{{ $sdata->student_id }}" data-category-id="{{ $sdata->category_id }}" data-batch-id="{{ $sdata->batch_id }}"
