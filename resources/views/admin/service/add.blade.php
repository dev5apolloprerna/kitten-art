            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                             <form method="POST" action="{{ route('service.store') }}" autocomplete="off" enctype="multipart/form-data" id="service_add">
                                @csrf
                                    <div class="row">
                                        <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('service_name') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" id="service_name" name="service_name" class="form-control" value="{{ old('service_name') }}" maxlength="100" required>
                                                <input type="hidden" id="slug" name="slug" class="form-control" value="{{ old('slug') }}" maxlength="100" required>
