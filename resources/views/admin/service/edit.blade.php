            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                             <form method="POST" action="{{ route('service.update',$data['service_id']) }}" autocomplete="off" enctype="multipart/form-data" id="service_edit">
                                @csrf
                               ...
                               <div class="row">
                                        <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('service_name') ? 'has-error' : '' }}">
                                                ...
                                                <input type="hidden" id="slug" name="slug" class="form-control" value="{{ $data['slug'] }}" maxlength="100" required>
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                                                ...
                                                <input type="hidden" name="hiddenImage" class="form-control"
                                                    ...
                                                    <div id="viewimg">
                                                        <img src="
                                                        {{ asset($data['image'] ? 'Service/' . $data['image'] : 'images/noImage.png') }}"
