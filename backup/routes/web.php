...
Route::fallback(function () {
    // return redirect('/'); // Redirect to the home page or index page
...
Route::prefix('admin')->name('attendance.')->middleware('auth')->group(function () {
    ...
    Route::get('student-attendance/edit/{id?}', [StudentAttendanceController::class, 'edit'])->name('edit');
    Route::post('student-attendance/update/{id?}', [StudentAttendanceController::class, 'update'])->name('update');
...
Route::post('/student-renew-plan', [FrontStudentController::class, 'student_renew_plan'])->name('student_renew_plan');
...
Route::get('/services-images/{id?}', [FrontController::class, 'service_gallery'])->name('FrontServiceImages');
