...
class TrialClassController extends Controller
{
    ...
    public function __construct(PlanRepositoryInterface $plan,TrialClassRepositoryInterface $trial,StudentRepositoryInterface $student)
    {
        $this->trial = $trial;
        $this->plan = $plan;
   ...
   public function index(Request $request)
    ...
    public function sendmail(Request $request)
    {
        ...
        {*/
            ...
            $file = file_get_contents($root . '/kitten_craft/mailers/trial-email.html', 'r');
    ...
    public function updatestatus(Request $request)
    {
        ...
        if($request->status == 1)
        {
            ...
            $this->student->createOrUpdate($trialclass->toArray());
