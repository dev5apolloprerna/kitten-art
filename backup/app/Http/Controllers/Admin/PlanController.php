   ...
   public function index(Request $request)
        ...
        try
        {
               ...
               $img = "";
                if ($request->hasFile('plan_image')) {
                    ...
                    $destinationpath = $root . '/kitten_craft/plan_image/';
    ...
    {     
         try
        {
            ...
            $root = $_SERVER['DOCUMENT_ROOT'];
            $destinationpath = $root . '/kitten_craft/plan_image/';
            if ($delete->plan_image && file_exists($destinationpath.'/'.$delete->plan_image)) {
                unlink($destinationpath  . $delete->plan_image);
            }
