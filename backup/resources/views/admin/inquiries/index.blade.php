                                        ...
                                        @foreach ($inquiries as $inquiry)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!--<a class="" href="{{route('Inquiry.view',[$inquiry->ebook_registration_id])}}" -->
                                                    <!--    title="View">-->
                                                    <!--    <i class="fa fa-eye" aria-hidden="true"></i>-->
                                                    <!--</a>-->
                                                        <a class="" href="#" data-bs-toggle="modal"
                                                            title="Delete" data-bs-target="#deleteRecordModal"
                                                            onclick="deleteData(<?= $inquiry->ebook_registration_id ?>);">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form id="user-delete-form" method="POST" action="{{ route('Inquiry.delete') }}">
                            @csrf
                            @method('DELETE')
                            <input type="hidden" name="ebook_registration_id" id="deleteid" value="">
