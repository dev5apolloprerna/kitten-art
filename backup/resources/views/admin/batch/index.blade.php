                                            ...
                                            <form method="POST" action="{{ route('batch.store') }}" autocomplete="off"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-4 mb-3">
                                                     ...
                                                     <input type="text" name="batch_name" id="batch_name" placeholder="Enter Batch Name" class="form-control" required>
                                                    </div>

                                                    <div class="mt-4 mb-3">
                                                            Batch Day <span style="color:red;">*</span>
                                                            <select class="form-control" name="batch_day" required>
                                        ...
                                        <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                                    ...
                                                    ?>
                                                        @foreach($batch as $key => $bdate)
                                                            <tr data-entry-id="{{ $bdate->batch_id }}">
                                                                <td>
...
$(document).ready(function() 
   {
        ...
        $('#editform-id').on('submit', function(e) {
            ...
            {
                $('<span class="text-danger">From Time is required.</span>')
                    .insertAfter('#editbatch_from_time');
                hasError = true;
            }
