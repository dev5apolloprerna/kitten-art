                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('plan_image') ? 'has-error' : '' }}">
                                                ...
                                                <input type="file" id="plan_image" name="plan_image" placeholder="Eneter Plan Image" class="form-control" value="{{ old('plan_image') }}" maxlength="10" onchange="return validateFile()" required>
                                        ...
                                        <div class="col-md-12 mt-4">
                                            <div class="form-group {{ $errors->has('plan_description') ? 'has-error' : '' }}">
                                                ...
                                                <textarea id="plan_description" rows="10" cols="10" name="plan_description" class="form-control ckeditor" value="{{ old('plan_description') }}" required></textarea>
