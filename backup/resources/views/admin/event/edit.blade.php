            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('events.update', $data['event_id']) }}" method="POST" id="form-id" enctype="multipart/form-data">
                                    @csrf
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-6 mt-4">
                                          ...
                                          <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('from_date') ? 'has-error' : '' }}">
                                                ...
                                                <input type="date" id="from_date" name="from_date" class="form-control" value="{{ $data['from_date'] }}"  required>
                                         ...
                                         <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('to_date') ? 'has-error' : '' }}">
                                                ...
                                                <input type="date" id="to_date" name="to_date" class="form-control" value="{{ $data['to_date'] }}"  required>
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('from_time') ? 'has-error' : '' }}">
                                                ...
                                                <input type="time" id="from_time" name="from_time" class="form-control" value="{{ $data['from_time'] }}"  required>
                                         ...
                                         <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('to_time') ? 'has-error' : '' }}">
                                                ...
                                                <input type="time" id="to_time" name="to_time" class="form-control" value="{{ $data['to_time'] }}"  required>
