                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" id="name" name="name" class="form-control"  maxlength="10" value="{{$data['name']}}" placeholder="Enter Name" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" readonly>
                                                @if($errors->has('name'))
