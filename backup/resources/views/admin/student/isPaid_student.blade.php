                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Student Payment List
                                ...
                                <form method="post" action="{{ route('student.index') }}" id="myForm">
                                    @csrf
                                     <div class="row"> 
                                        ...
                                        <div class="col-md-5"> 
                                            <div class="form-group">
                                                <label for="name">Search By Batch Day</label>
                                            <select name="batch" id="batch" class="form-control" value="{{ old('batch', isset($batch) ? $batch : '') }}">
                                                    <option value="">Select Day</option>
                                                    <option value="1" {{ $batch == 1 ? 'selected' : '' }}>Monday</option>
                                                    <option value="2" {{ $batch == 2 ? 'selected' : '' }}>Tuesday</option>
                                                    <option value="3" {{ $batch == 3 ? 'selected' : '' }}>Wednesday</option>
                                                    <option value="4" {{ $batch == 4 ? 'selected' : '' }}>Thursday</option>
                                                    <option value="5" {{ $batch == 5 ? 'selected' : '' }}>Friday</option>
                                                    <option value="6" {{ $batch == 6 ? 'selected' : '' }}>Saturday</option>
                                                    <option value="7" {{ $batch == 7 ? 'selected' : '' }}>Sunday</option>
                                                </select>
                                            </div>
                                        </div>
