                                            ...
                                            <tbody>
                                                <?php $i = 1; ?>
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td>
                                                            <a target="_blank"  href="{{ asset('Gallery/') . '/' . $glry->image }}">
                                                            <img width="50" height="50" src="{{ asset('Gallery/') . '/' . $glry->image }}"></a>
                                                        </td>
                ...
                $.ajax({
                    ...
                    success: function(data) 
                    {
                        ...
                        if(obj.image == null)
                        {
                            ...
                            var imageUrl="https://getdemo.in/kitten_craft/Gallery/"+obj.image;
                        }
