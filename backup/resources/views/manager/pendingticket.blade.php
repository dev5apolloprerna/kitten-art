        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" id="form" action="{{ route('managerticket.pendingticket') }}">
                                @csrf
                                <div class="row mt-3 align-items-center">
                                    ...
                                    <div class="col-md-3 mt-2 mb-2">
                                        <div class="d-flex align-items-center">
                                            <input placeholder="Ticket Name" type="text" class="form-control"
                                        ...
                                        <div class="d-flex align-items-center">
                                            <select class="form-control" name="employee">
                                                ...
                                                @foreach ($GetEmployee as $GetEmployees)
                                                    <option value="{{ $GetEmployees->id }}"
                                                        <?= isset($Employee) && $GetEmployees->id == $Employee ? 'Selected' : '' ?>>
                                                        {{ $GetEmployees->first_name . ' ' . $GetEmployees->last_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($Ticket as $ticket)
                                            <tr>
                                                <td>{{ $i + $Ticket->perPage() * ($Ticket->currentPage() - 1) }}</td>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                    ...
                                    <form id="user-delete-form" method="POST"
                                        action="{{ route('tickettype.delete') }}">
                                        @csrf
                                        @method('DELETE')
