              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  ...
                  <!--<ul class="dropdown-menu">
                    ...
                    <li class="nav-item">
                      <a href="{{route('FrontClassDetail',$category->category_id)}}" class="nav-link"> {{ $category->category_name }}</a>
                    </li>
                    @endforeach
                  </ul>-->
                </li>
               <!--  <li class="nav-item">
                ...
                <li class="nav-item">
                  <a href="{{route('FrontEvents')}}" class="nav-link @if (request()->routeIs('FrontEvents')) {{ 'active' }} @endif"> Events  <!--<i class="bx bx-chevron-down"></i>--> </a>
                  <!--<ul class="dropdown-menu">
                    <?php
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link @if (request()->routeIs('FrontServiceImages')) {{ 'active' }} @endif"> Service <i class="bx bx-chevron-down"></i></a>
                  <ul class="dropdown-menu">
                    <?php
                      $Service = App\Models\Service::orderBy('service_name', 'asc')->get();
                     ?>
                     @foreach ($Service as $e)
                    <li class="nav-item">
                      <a href="{{route('FrontServiceImages',$e->service_id)}}" class="nav-link "> {{ $e->service_name }}</a>
                    </li>
                    @endforeach
                  </ul>
                </li> 
