                ...
                <div class="event-box-item">
                    <div class="row align-items-center">
                      ...
                      <div class="form-group mb-2">Parent Photo<span style="color:red";>*</span>
                          <input type="file" class="form-control"  name="parent_photo"  id="parent_photo" onchange="return validateFile()" required>
                      </div>
                      <div class="form-group mb-2">Student Photo<span style="color:red";>*</span>
                          <input type="file" class="form-control" name="student_photo" id="student_photo" onchange="return validateFile1()" required>
                      </div>
