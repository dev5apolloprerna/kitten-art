    ...
    <div class="container">
        ...
        <div class="row clearfix">
          ...
          <div class="contact-panel">
            ...
            <form method="post" action="{{ route('contactStore') }}" id="myContactForm">
                @csrf
              <div class="row">
                ...
                <div class="col-sm-6 mb-3 form-group-icon">
                  <i class="bi bi-person"></i>
                  <input type="text" class="form-control" name="student_age" placeholder="Student Age *" value="{{ old('student_age') }}" max="99" min="0" oninput="if(this.value.length > 2) this.value = this.value.slice(0, 2);" required>
                </div>
                <div class="col-sm-6 mb-3 form-group-icon">
                  <i class="bi bi-person"></i>
                  <input type="text" class="form-control" name="parent_name" id="parent_name" placeholder="Parents Name" value="{{ old('parent_name') }}" minlength="3"  maxlength="20" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '')" required>
                ...
                <div class="col-sm-6 mb-3 form-group-icon">
                  ...
                  <input type="text" class="form-control" name="mobile" placeholder="Phone *" value="{{ old('mobile') }}" maxlength="10"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"required>
                </div>
                <div class="col-sm-6 mb-3 form-group-icon">
