                                                ...
                                                {{--  <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control" name="role_id"
                                                            onchange="managerbind();" id="managersssss" required>
                                                            <option selected disabled value="">Select User Type
                                                            </option>
                                                            @foreach ($roles as $role)
                                                                <option value="{{ $role->id }}"
                                                                    {{ old('role_id') ? (old('role_id') == $role->id ? 'selected' : '') : (auth()->user()->role_id == $role->id ? 'selected' : '') }}>
                                                                    {{ $role->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
