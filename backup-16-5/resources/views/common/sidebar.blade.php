            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                        ...
                        <div class="menu-dropdown collapse {{ in_array(request()->route()->getName(), ['studentinquiry.index', 'student.index', 'student.register_student', 'student.active_student', 'renewPlan.renew_plan','student.view','studentinquiry.view', 'studentinquiry.edit','student.edit','student.active_student_view','renewPlan.edit_renew_student','student.inactive_student']) ? 'show' : '' }}
                        " id="sidebarDashboards" style="">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    ...
                                    @if (request()->routeIs('student.active_student', 'student.active_student_view')) active @endif"
                                        data-key="t-crm">
                                ...
                                <li class="nav-item">
                                 ...
                                 <li class="nav-item">
                                    <a href="{{ route('student.inactive_student') }}" class="nav-link menu-link 
                                 @if (request()->routeIs('student.inactive_student')) active @endif"
                                        data-key="t-crm">
