               ...
               <!--  <li class="nav-item">
                ...
                <li class="nav-item">
                  <?php 
                      ...
                      ?>
                    <a href="{{ route('FrontServiceImages', $Service->service_id) }}"
                       id="service-{{ $Service->service_id }}"
                       class="nav-link @if (request()->routeIs('FrontServiceImages') && request()->route('id') == 2) active @endif">
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link @if (request()->routeIs('FrontServiceImages') && request()->route('id') != 2) {{ 'active' }} @endif"> Service <i class="bx bx-chevron-down"></i></a>
                  <ul class="dropdown-menu">
                    <?php
