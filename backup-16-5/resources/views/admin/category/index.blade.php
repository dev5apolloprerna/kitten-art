                            ...
                            <div class="card-body">
                                <div class="row">
                                            ...
                                            <form method="POST" action="{{ route('category.store') }}" autocomplete="off"
                                                ...
                                                <div class="modal-body">
                                                    <div class="mt-4 mb-3">
                                                        ...
                                                        <input type="text" id="category_name" name="category_name" class="form-control" value="{{ old('category_name') }}" placeholder="Enter Category Name" maxlength="20" required>  
                                    ...
                                    <div class="col-lg-8">
                                             ...
                                             <!--<form method="post" action="{{ route('category.index') }}" id="myForm">
                                                    @csrf
                                                <div class="mt-4 mb-3">
                                        ...
                                        <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                            ...
                                            <tbody>
                                             @if(count($category) > 0)
                                                ...
                                                <?php $i = 1; ?>
                                                    @foreach($category as $key => $mn)
                                                    <tr class="text-center">
                                                        <td>{{ $i + $category->perPage() * ($category->currentPage() - 1) }}
                                                        </td>
                                                        <td>{{ $mn->category_name ?? '' }}</td>
