                                                ...
                                                <table class=" table table-bordered table-striped table-hover datatable">
                                                    ...
                                                    ?>
                                                        @foreach($event as $key => $edata)
                                                            <tr data-entry-id="{{ $edata->event_id }}" class="text-center"> 
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <a href="{{ asset($edata->image ? 'Events/' . $edata->image : 'images/noImage.png') }}"
                                                                        target="_blank" class="mx-1">
                                                                        <img src="{{ asset($edata->image ? 'Events/' . $edata->image : 'images/noImage.png') }}" alt="" width="50px" height="50px">
                                                                    </a>
                                                                </td>
                                                                <td>
