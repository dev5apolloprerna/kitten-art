                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-4">
                                         ...
                                         <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('from_date') ? 'has-error' : '' }}">
                                                ...
                                                <input type="date" id="from_datee" name="from_date" class="form-control" value="{{ old('from_date') }}"  required>
                                         ...
                                         <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('to_date') ? 'has-error' : '' }}">
                                                ...
                                                <input type="date" id="to_datee" name="to_date" class="form-control" value="{{ old('to_date') }}"  required>
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('from_time') ? 'has-error' : '' }}">
                                                ...
                                                <input type="time" id="from_timee" name="from_time" class="form-control" value="{{ old('from_time') }}"  required>
                                         ...
                                         <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('to_time') ? 'has-error' : '' }}">
                                                ...
                                                <input type="time" id="to_timee" name="to_time" class="form-control" value="{{ old('to_time') }}"  required>
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                                                ...
                                                <input type="file" id="image" name="image" class="form-control" value="{{ old('image') }}" onchange="return validateFile()" required>
                                                @if($errors->has('image'))
                                                    <span class="text-danger">
                                                        {{ $errors->first('image') }}
                                                    </span>
