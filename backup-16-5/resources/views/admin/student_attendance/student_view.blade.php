                                                    ...
                                                    <tr>
                                                       ...
                                                       <td>
                                                         @if($loop->first) <!-- Check if this is the last record -->
                                                            <a  title="Change Attendance Status" href="#"  data-bs-toggle="modal" data-bs-target="#attendanceModal_{{ $a->attendence_id }}"onclick="attendanceData(<?= $a->attendence_id ?>);"class="mx-2">
