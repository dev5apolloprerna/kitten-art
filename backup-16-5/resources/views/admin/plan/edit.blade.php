            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                    <form action="{{ route('plan.update', $data['planId']) }}" method="POST" enctype="multipart/form-data" id="editplanForm">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <div class="form-group {{ $errors->has('plan_image') ? 'has-error' : '' }}">
                                                ...
                                                <input type="file" id="plan_image" name="plan_image" class="form-control" value="{{ old('plan_image') }}" onchange="return validateFile()">
                                                    <input type="hidden" name="hiddenImage" class="form-control"
                                                        value="{{ old('plan_image') ? old('plan_image') : $data['plan_image'] }}"
                                                        id="hiddenImage">
                                                    <div id="viewimg">
                                                        <img src="{{ asset($data['plan_image'] ? 'plan_image/' . $data['plan_image'] : 'images/noImage.png') }}"
